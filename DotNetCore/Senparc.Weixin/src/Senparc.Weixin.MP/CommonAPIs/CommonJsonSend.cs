...
namespace Senparc.Weixin.MP.CommonAPIs
{
	public static class CommonJsonSend
	{
		...
		public static WxJsonResult Send(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST, int timeOut = Config.TIME_OUT, bool checkValidationResult = false/*, int retry40001ErrorTimes = 0*/)
		{
