...
namespace Senparc.Weixin.MP
{
	...
	{
		[Display(Description = "文本")]
		Text = 0,
		[Display(Description = "单图文")]
		News = 1,
		[Display(Description = "音乐")]
		Music = 2,
		[Display(Description = "图片")]
		Image = 3,
		[Display(Description = "语音")]
		Voice = 4,
		[Display(Description = "视频")]
		Video = 5,
		[Display(Description = "多客服")]
		Transfer_Customer_Service,
		//transfer_customer_service

		//以下为延伸类型，微信官方并未提供具体的回复类型
		[Display(Description = "多图文")]
		MultipleNews = 106,
		[Display(Description = "位置")]
		LocationMessage = 107,//
		[Display(Description = "无回复")]
		NoResponse = 110,
	}
