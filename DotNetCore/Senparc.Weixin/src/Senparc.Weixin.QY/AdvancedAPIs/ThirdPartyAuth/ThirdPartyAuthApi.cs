...
using Senparc.Weixin.QY.AdvancedAPIs.ThirdPartyAuth.ThirdPartyAuthJson;
...
namespace Senparc.Weixin.QY.AdvancedAPIs
{
	public static class ThirdPartyAuthApi
	{
		...
		/// <param name="timeOut">代理请求超时时间（毫秒）</param>
		/// <returns></returns>
		public static GetPreAuthCodeResult GetPreAuthCode(string suiteAccessToken, string suiteId, int timeOut = Config.TIME_OUT)
		{
		...
		/// <param name="timeOut">代理请求超时时间（毫秒）</param>
		/// <returns></returns>
		public static object SetAuthConfig(string suiteAccessToken, string authCode, int[] appid, int auth_type, int timeOut = Config.TIME_OUT)
		{
