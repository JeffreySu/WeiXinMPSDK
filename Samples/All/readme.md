...
| 文件夹 | 说明 |
|--------|--------|
|   net10-mvc      |   【快速更新，推荐】.NET 10.0 示例，可用于直接部署
|   ~~net8-mvc~~      |   ~~【停止更新】.NET 8.0 示例，可用于直接部署~~
...
> 如果你希望学习并使用最新的 .NET 10.0 框架，并且已经安装了 VS2022（v16.9 以上），并且希望调试 .NET 10.0 及以上版本，那么请打开：net10-mvc/Senparc.Weixin.Sample.Net10.sln 解决方案
...
Senparc.Weixin.Sample.CommonService 里面包含了 CustomMessageHandler 等在多个不同框架的 Sample 中可以重用的代码，例如可以在 .NET Framework / .NET 8.0 / .NET 10.0 / WebForms 等不同环境中重用。
