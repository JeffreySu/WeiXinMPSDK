    ...
    public class TenPayRealV3Controller : BaseController
    {
        ...
        public async Task<IActionResult> JsApi(int productId, int hc)
        {
            try
            {
                ...
                JsApiRequestData jsApiRequestData = new(TenPayV3Info.AppId, TenPayV3Info.MchId, name, sp_billno, new TenpayDateTime(DateTime.Now.AddHours(1), false), null, notifyUrl, null, new JsApiRequestData.Amount { currency = "CNY", total = price }, new JsApiRequestData.Payer(openId), null, null, null);
