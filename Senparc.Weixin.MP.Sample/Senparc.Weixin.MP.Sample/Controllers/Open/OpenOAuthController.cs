...
namespace Senparc.Weixin.MP.Sample.Controllers
{
    ...
    public class OpenOAuthController : Controller
    {
        ...
        {
            //此页面引导用户点击授权
            ViewData["UrlUserInfo"] = Open.OAuth.OAuthApi.GetAuthorizeUrl(appId, "http://weixin.senparc.com/OpenOAuth/UserInfoCallback?appId="+appId, "JeffreySu", Open.OAuthScope.snsapi_userinfo);
            ViewData["UrlBase"] = Open.OAuth.OAuthApi.GetAuthorizeUrl(appId, "http://weixin.senparc.com/OpenOAuth/BaseCallback?appId=" + appId, "JeffreySu", Open.OAuthScope.snsapi_base);
            return View();
        }
