...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class WeixinShopOrder
    {
        ...
        /// <returns></returns>
        public static GetByIdOrderResult GetByIdOrder(string appId, string orderId)
        {
        ...
        /// <returns></returns>
        public static GetByFilterResult GetByFilterOrder(string appId, int status, string beginTime, string endTime)
        {
            var accessToken = AccessTokenContainer.GetToken(appId);
        ...
        /// 汇通快运	020huitong
        /// 易迅快递	zj001yixun
        public static WxJsonResult SetdeliveryOrder(string appId, string orderId, string deliveryCompany, string deliveryTrackNo)
        {
            var accessToken = AccessTokenContainer.GetToken(appId);
        ...
        /// <param name="orderId">订单ID</param>
        /// <returns></returns>
        public static WxJsonResult CloseOrder(string appId, string orderId)
        {
            var accessToken = AccessTokenContainer.GetToken(appId);
