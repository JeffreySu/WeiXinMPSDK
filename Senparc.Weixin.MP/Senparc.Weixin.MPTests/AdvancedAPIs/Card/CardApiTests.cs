...
namespace Senparc.Weixin.MP.AdvancedAPIs.Tests
{
    ...
    public class CardApiTests
    {
        ...
        //            begin_timestamp = DateTimeHelper.GetWeixinDateTime(card.card_effect),
        //            end_timestamp = DateTimeHelper.GetWeixinDateTime(card.card_disabled),
        //        },
        ...
        //    };
        //    var cardResult = CardApi.CreateCard(GetToken(), cash);
        //}
    }
}