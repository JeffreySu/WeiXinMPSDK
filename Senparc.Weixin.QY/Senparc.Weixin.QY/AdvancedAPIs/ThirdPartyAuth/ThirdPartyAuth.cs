...
namespace Senparc.Weixin.QY.AdvancedAPIs
{
    ...
    public static class ThirdPartyAuth
    {
        ...
        public static GetSuiteTokenResult GetSuiteToken(string suiteId, string suiteSecret, string suiteTicket)
        {
            ...
            return CommonJsonSend.Send<GetSuiteTokenResult>(null, url, data, CommonJsonSendType.POST);
        }
        ...
        public static GetPreAuthCodeResult GetPreAuthCode(string suiteAccessToken, string suiteId, int[] appId)
        {
            ...
            return CommonJsonSend.Send<GetPreAuthCodeResult>(null, url, data, CommonJsonSendType.POST);
        }
        ...
        public static GetPermanentCodeResult GetPermanentCode(string suiteAccessToken, string suiteId, string authCode)
        {
            ...
            return CommonJsonSend.Send<GetPermanentCodeResult>(null, url, data, CommonJsonSendType.POST);
        }
        ...
        /// <returns></returns>
        public static GetAuthInfoResult GetAuthInfo(string suiteAccessToken, string suiteId, string authCorpId, string permanentCode)
        {
            ...
            return CommonJsonSend.Send<GetAuthInfoResult>(null, url, data, CommonJsonSendType.POST);
        }
        ...
        /// <returns></returns>
        public static GetAgentResult GetAgent(string suiteAccessToken, string suiteId, string authCorpId, string permanentCode, string agentId)
        {
            ...
            return CommonJsonSend.Send<GetAgentResult>(null, url, data, CommonJsonSendType.POST);
        }
        ...
        /// <returns></returns>
        public static WxJsonResult SetAgent(string suiteAccessToken, string suiteId, string authCorpId, string permanentCode, ThirdParty_AgentData agent)
        {
        ...
        /// <param name="permanentCode">永久授权码，通过get_permanent_code获取</param>
        /// <returns></returns>
        public static GetCorpTokenResult GetCorpToken(string suiteAccessToken, string suiteId, string authCorpId, string permanentCode)
        {
            ...
            return CommonJsonSend.Send<GetCorpTokenResult>(null, url, data, CommonJsonSendType.POST);
        }
    }
}
