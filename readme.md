...
> 1、_针对 7 月 4 日微信爆出的官方推荐代码存在 XXE 漏洞，Senparc 已经在当天提供了更新版本，在更新过程中不少开发者版本跨度比较大，很多人出现了“当前扩展缓存策略没有进行注册”的异常，可以参考做法（只需要一行代码）：https://www.cnblogs.com/szw/p/9265828.html<br>
