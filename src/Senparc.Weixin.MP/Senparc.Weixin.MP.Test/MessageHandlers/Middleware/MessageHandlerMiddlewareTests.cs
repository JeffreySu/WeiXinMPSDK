...
";
            ...
            var messageHandlerMiddleware = new MpMessageHandlerMiddleware<DefaultMpMessageContext,SenparcWeixinSetting>(null, CustomMessageHandlers.GenerateMessageHandler, options =>
             {
