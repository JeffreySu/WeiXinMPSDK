...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class GroupMessageApi
    {
        ...
        public static SendResult SendGroupMessageByGroupId(string accessTokenOrAppId, string groupId, string value, GroupMessageType type, bool isToAll = false, bool sendIgnoreReprint = false, int timeOut = Config.TIME_OUT)
        {
            ...
            {
                const string urlFormat = Config.ApiMpHost + "/cgi-bin/message/mass/sendall?access_token={0}";
        ...
        public static SendResult SendGroupMessageByOpenId(string accessTokenOrAppId, GroupMessageType type, string value, int timeOut = Config.TIME_OUT, params string[] openIds)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                const string urlFormat = Config.ApiMpHost + "/cgi-bin/message/mass/send?access_token={0}";
        ...
        public static WxJsonResult DeleteSendMessage(string accessTokenOrAppId, string msgId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                const string urlFormat = Config.ApiMpHost + "/cgi-bin/message/mass/delete?access_token={0}";
        ...
        public static SendResult SendGroupMessagePreview(string accessTokenOrAppId, GroupMessageType type, string value, string openId, string wxName = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                const string urlFormat = Config.ApiMpHost + "/cgi-bin/message/mass/preview?access_token={0}";
        ...
        public static GetSendResult GetGroupMessageResult(string accessTokenOrAppId, string msgId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                const string urlFormat = Config.ApiMpHost + "/cgi-bin/message/mass/get?access_token={0}";
