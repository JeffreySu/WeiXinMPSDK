...
namespace Senparc.Weixin.MP.AdvancedAPIs.MerChant
{
    ...
    public static class GroupApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.AddGroup", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.DeleteGroup", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.PropertyModGroup", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.ProductModGroup", true)]
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.GetAllGroup", true)]
        ...
        /// <param name="groupId">分组Id</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.GetByIdGroup", true)]
        ...
        /// <param name="addGroupData">增加分组需要Post的数据</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.AddGroupAsync", true)]
        ...
        /// <param name="groupId">分组Id</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.DeleteGroupAsync", true)]
        ...
        /// <param name="propertyModGroup">修改分组属性需要Post的数据</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.PropertyModGroupAsync", true)]
        ...
        /// <param name="productModGroup">修改分组商品需要Post的数据</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.ProductModGroupAsync", true)]
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.GetAllGroupAsync", true)]
        ...
        /// <param name="groupId">分组Id</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "GroupApi.GetByIdGroupAsync", true)]
