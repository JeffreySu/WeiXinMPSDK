...
namespace Senparc.Weixin.MP.AdvancedAPIs.MerChant
{
    ...
    {
        #region 同步方法
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "PictureApi.UploadImg", true)]
        ...
        #region 异步方法
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "PictureApi.UploadImgAsync", true)]
