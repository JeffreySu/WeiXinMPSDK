...
namespace Senparc.Weixin.MP.AdvancedAPIs.MerChant
{
    ...
    public static class ProductApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.AddProduct", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.DeleteProduct", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.UpDateProduct", true)]
        ...
        /// <param name="productId">商品的Id</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetProduct", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetByStatus", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.ModProductStatus", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetSub", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetSku", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetProperty", true)]
        ...
        /// <param name="addProductData">提交到接口的数据（AddProductData）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.AddProductAsync", true)]
        ...
        /// <param name="productId">商品的Id</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.DeleteProductAsync", true)]
        ...
        /// <param name="reviseProduct">修改商品的信息</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.UpDateProductAsync", true)]
        ...
        /// <param name="productId">商品的Id</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetProductAsync", true)]
        ...
        /// <param name="status">商品状态(0-全部, 1-上架, 2-下架)</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetByStatusAsync", true)]
        ...
        /// <param name="productId">商品ID</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.ModProductStatusAsync", true)]
        ...
        /// <param name="cateId">大分类ID(根节点分类id为1)</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetSubAsync", true)]
        ...
        /// <param name="cateId">商品子分类ID</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetSkuAsync", true)]
        ...
        /// <param name="cateId">分类ID</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "ProductApi.GetPropertyAsync", true)]
