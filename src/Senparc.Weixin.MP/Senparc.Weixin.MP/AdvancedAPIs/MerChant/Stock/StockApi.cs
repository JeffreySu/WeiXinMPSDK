...
namespace Senparc.Weixin.MP.AdvancedAPIs.MerChant
{
    ...
    public static class StockApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "StockApi.AddStock", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "StockApi.ReduceStock", true)]
        ...
        /// <param name="addStockData">增加库存需要Post的数据</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "StockApi.AddStockAsync", true)]
        ...
        /// <param name="reduceStockData">减少库存需要Post的数据</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "StockApi.ReduceStockAsync", true)]
