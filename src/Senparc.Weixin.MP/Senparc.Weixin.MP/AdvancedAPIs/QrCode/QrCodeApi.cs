...
/*----------------------------------------------------------------
    ...
    修改描述：v16.9.0 QrCodeApi.Create() 参数说明更改
...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class QrCodeApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "QrCodeApi.Create", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "QrCodeApi.GetShowQrCodeUrl", true)]
        ...
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "QrCodeApi.ShowQrCode", true)]
        ...
        /// <param name="actionName">二维码类型，当actionName为QR_LIMIT_STR_SCENE或QR_STR_SCENE时，sceneId会被忽略</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "QrCodeApi.CreateAsync", true)]
        ...
        /// <param name="ticket"></param>
        /// <param name="stream"></param>
        [NcApiBind(NeuChar.PlatformType.WeChat_OfficialAccount, "QrCodeApi.ShowQrCodeAsync", true)]
