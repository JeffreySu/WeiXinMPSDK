...
namespace Senparc.Weixin.MP.CommonAPIs
{
    ...
    public static class CommonJsonSend
    {
		...
		public static WxJsonResult Send(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST, int timeOut = Config.TIME_OUT, bool checkValidationResult = false)
		{
			WxJsonResult result = null;
			try
			{
				result = Weixin.CommonAPIs.CommonJsonSend.Send(accessToken, urlFormat, data, sendType, timeOut);
			}
