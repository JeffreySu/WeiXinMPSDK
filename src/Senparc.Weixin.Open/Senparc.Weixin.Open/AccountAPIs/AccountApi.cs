...
namespace Senparc.Weixin.Open.AccountAPIs
{
    ...
    public class AccountApi
    {
        ...
        /// </param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.FastRegisterAuth", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.FastRegister", true)]
        ...
        /// </param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.GetAccountBasicInfo", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.ModifyHeadImage", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.ModifySignature", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.ComponentRebindAdmin", true)]
        ...
        /// <param name="ticket">公众号扫码授权的凭证(公众平台扫码页面回跳到第三方平台时携带)</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.FastRegisterAsync", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.GetAccountBasicInfoAsync", true)]
        ...
        /// <param name="y2">裁剪框右下角y坐标（取值范围：[0, 1]）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.ModifyHeadImageAsync", true)]
        ...
        /// <param name="signature">功能介绍</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.ModifySignatureAsync", true)]
        ...
        /// <para><see cref="Senparc.Weixin.Open.WxOpenAPIs.WxOpenApi.ComponentRebindAdmin"/></para></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "AccountApi.ComponentRebindAdminAsync", true)]
