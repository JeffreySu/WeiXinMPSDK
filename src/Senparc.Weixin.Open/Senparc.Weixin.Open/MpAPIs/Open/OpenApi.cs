...
namespace Senparc.Weixin.Open.MpAPIs.Open
{
    public static class OpenApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.Create", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.Bind", true)]
        ...
        /// <param name="openAppid">开放平台帐号appid</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.Unbind", true)]
        ...
        /// <param name="appId">授权公众号或小程序的appid</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.Get", true)]
        ...
        /// <param name="appId">授权公众号或小程序的appid</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.CreateAsync", true)]
        ...
        /// <param name="openAppid">开放平台帐号appid</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.BindAsync", true)]
        ...
        /// <param name="openAppid">开放平台帐号appid</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.UnbindAsync", true)]
        ...
        /// <param name="appId">授权公众号或小程序的appid</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OpenApi.GetAsync", true)]
