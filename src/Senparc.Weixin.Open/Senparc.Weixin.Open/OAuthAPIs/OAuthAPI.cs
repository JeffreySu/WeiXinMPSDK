...
namespace Senparc.Weixin.Open.OAuthAPIs
{
    ...
    public static class OAuthApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OAuthApi.GetAuthorizeUrl", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OAuthApi.GetAccessToken", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OAuthApi.RefreshToken", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OAuthApi.GetUserInfo", true)]
        ...
        /// <param name="grantType"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OAuthApi.GetAccessTokenAsync", true)]
        ...
        /// <param name="componentAppid"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OAuthApi.RefreshTokenAsync", true)]
        ...
        /// <param name="lang">返回国家地区语言版本，zh_CN 简体，zh_TW 繁体，en 英语</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "OAuthApi.GetUserInfoAsync", true)]
