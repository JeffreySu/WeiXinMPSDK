...
namespace Senparc.Weixin.Open.QRConnect
{
    ...
    public static class QRConnectAPI
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.GetQRConnectUrl", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.GetAccessToken", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.RefreshToken", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.GetUserInfo", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.Auth", true)]
        ...
        /// <param name="grantType">填authorization_code</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.GetAccessTokenAsync", true)]
        ...
        /// <param name="grantType">填refresh_token</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.RefreshTokenAsync", true)]
        ...
        /// <param name="openId">普通用户的标识，对当前公众号唯一</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.GetUserInfoAsync", true)]
        ...
        /// <param name="openId">用户的唯一标识</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "QRConnectAPI.AuthAsync", true)]
