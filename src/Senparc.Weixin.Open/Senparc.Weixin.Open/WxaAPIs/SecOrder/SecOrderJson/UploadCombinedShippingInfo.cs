...
/*----------------------------------------------------------------
    ...
    文件名：UploadCombinedShippingInfo.cs
    文件功能描述：发货信息合单录入接口
...
namespace Senparc.Weixin.Open.WxaAPIs.SecOrder
{
    ...
    /// 发货信息合单录入接口
    /// </summary>
    public class UploadCombinedShippingInfo
    {
        /// <summary>
        /// 【必填】合单订单，需要上传物流详情的合单订单，根据订单类型二选一
        /// </summary>
        ...
        /// 【非必填】子单物流详情
        /// </summary>
        public List<UploadCombinedShippingInfo_SubOrder> sub_orders { get; set; }
    ...
    /// 
    /// </summary>
    public class UploadCombinedShippingInfo_SubOrder
    {
        /// <summary>
        /// 【必填】订单，需要上传物流信息的订单
        /// </summary>
