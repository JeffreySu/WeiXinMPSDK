...
namespace Senparc.Weixin.Open.WxaAPIs
{
    public class SetWebViewDomainApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "SetWebViewDomainApi.SetWebViewDomain", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "SetWebViewDomainApi.SetWebViewDomainAsync", true)]
