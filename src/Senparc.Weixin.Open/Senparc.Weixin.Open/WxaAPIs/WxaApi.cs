...
namespace Senparc.Weixin.Open.WxaAPIs
{
    public class WxaApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "WxaApi.GetShowWxaItem", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "WxaApi.GetWxaMpLinkForShow", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "WxaApi.UpdateShowWxaItem", true)]
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "WxaApi.GetShowWxaItemAsync", true)]
        ...
        /// <param name="num">每页记录数，最大为 20</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "WxaApi.GetWxaMpLinkForShowAsync", true)]
        ...
        /// <param name="appid">如果开启，需要传新的公众号 appid</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Open, "WxaApi.UpdateShowWxaItemAsync", true)]
