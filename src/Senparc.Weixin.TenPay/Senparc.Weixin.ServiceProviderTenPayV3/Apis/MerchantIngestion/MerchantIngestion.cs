...
namespace Senparc.Weixin.ServiceProviderTenPayV3.Apis
{
    public class MerchantIngestion
    {
        ...
        public async Task<ApplymentResultJson> ApplymentAsync(ApplymentRequestData data, int timeOut = Config.TIME_OUT)
        {
            ...
            return await tenPayApiRequest.RequestAsync<ApplymentResultJson>(url, data, timeOut, ApiRequestMethod.POST,
                checkSign: false);
        }
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public async Task<GetApplymentResultJson> GetApplymentAsync(GetApplymentRequestData data,
            int timeOut = Config.TIME_OUT)
        {
            var url = GetApplymentApis.GetPayApiUrl(Senparc.Weixin.Config.TenPayV3Host +
                                                    $"/v3/applyment4sub/applyment/business_code/{data.business_code} ");
            TenPayApiRequest tenPayApiRequest = new(_tenpayV3Setting);
            return await tenPayApiRequest.RequestAsync<GetApplymentResultJson>(url, data, timeOut, ApiRequestMethod.GET,
                checkSign: false);
        }
        ...
        {
            var url = GetApplymentApis.GetPayApiUrl(Senparc.Weixin.Config.TenPayV3Host +
                                                    $"/v3/applyment4sub/applyment/applyment_id/{data.applyment_id} ");
            TenPayApiRequest tenPayApiRequest = new(_tenpayV3Setting);
            return await tenPayApiRequest.RequestAsync<GetApplymentResultJson>(url, data, timeOut, ApiRequestMethod.GET,
                checkSign: false);
        }
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public async Task<ResultJsonBase> ModifySettlementAsync(ModifySettlementRequestData data,
            int timeOut = Config.TIME_OUT)
        {
            var url = ModifySettlementApis.GetPayApiUrl(Senparc.Weixin.Config.TenPayV3Host +
                                                        $"/v3/apply4sub/sub_merchants/{data.sub_mchid}/modify-settlement");
            TenPayApiRequest tenPayApiRequest = new(_tenpayV3Setting);
            return await tenPayApiRequest.RequestAsync<ResultJsonBase>(url, data, timeOut, ApiRequestMethod.POST,
                checkSign: false);
        }
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public async Task<GetSettlementResultJson> GetSettlementAsync(GetSettlementRequestData data,
            int timeOut = Config.TIME_OUT)
        {
            var url = GetSettlementApis.GetPayApiUrl(Senparc.Weixin.Config.TenPayV3Host +
                                                     $"/v3/apply4sub/sub_merchants/{data.sub_mchid}/settlement");
            TenPayApiRequest tenPayApiRequest = new(_tenpayV3Setting);
            return await tenPayApiRequest.RequestAsync<GetSettlementResultJson>(url, data, timeOut,
                ApiRequestMethod.GET, checkSign: false);
        }
