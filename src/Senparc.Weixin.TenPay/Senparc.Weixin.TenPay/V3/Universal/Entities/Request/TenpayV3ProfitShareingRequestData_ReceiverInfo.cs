/*----------------------------------------------------------------
    ...
    文件名：TenpayV3ProfitShareingRequestData_ReceiverInfo.cs
    文件功能描述：定义微信支付分账接收方请求参数


    创建标识：Senparc - 20200303

    修改标识：Senparc - 20260726
    修改描述：v1.19.0 切换到 System.Text.Json 忽略标记以支持源生成序列化；增强微信支付请求模型的 Native AOT 序列化兼容能力
