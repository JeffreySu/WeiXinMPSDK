...
{
    public class CloseRequestData
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public CloseRequestData() { }

        /// <summary>
        /// 含参构造函数(商家模式)
        /// </summary>
        /// <param name="mchid">直连商户的商户号，由微信支付生成并下发。 示例值：1230000109</param>
        /// <param name="order_no">商户系统内部订单号</param>
        public CloseRequestData(string mchid, string out_trade_no)
        {
            this.mchid = mchid;
        ...
        /// <param name="order_no">商户系统内部订单号</param>
        public CloseRequestData(string sp_mchid, string sub_mchid, string out_trade_no)
        {
