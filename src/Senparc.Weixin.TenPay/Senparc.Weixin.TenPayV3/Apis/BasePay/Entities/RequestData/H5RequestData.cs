...
namespace Senparc.Weixin.TenPayV3.Apis.BasePay
{
    public class H5RequestData
    {
        ...
        public H5RequestData(string appid, string mchid, string description, string out_trade_no, TenpayDateTime time_expire, string attach, string notify_url, string goods_tag, Amount amount, Detail detail, Settle_Info settle_info, Scene_Info scene_info)
        {
            this.appid = appid;
            this.mchid = mchid;
