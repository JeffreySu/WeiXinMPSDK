...
namespace Senparc.Weixin.TenPayV3.Apis.BasePay
{
    public class NativeCombineRequestData
    {
        ...
        /// <param name="combine_out_trade_no">合单支付总订单号</param>
        ...
        public NativeCombineRequestData(string combine_appid, string combine_mchid, string combine_out_trade_no, Scene_Info scene_info, Sub_Orders[] sub_orders, Combine_Payer_Info combine_payer_info, TenpayDateTime time_start, TenpayDateTime time_expire, string notify_url)
        {
