...
/*----------------------------------------------------------------
    ...
    文件名：QueryComplaintNotifyUrlReturnJson.cs
    文件功能描述：查询投诉通知回调地址返回Json类
...
namespace Senparc.Weixin.TenPayV3.Apis.Complaint
{
    /// <summary>
    /// 查询投诉单列表返回Json类
    /// <para>详细请参考微信支付官方文档 https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter10_2_3.shtml </para>
    /// </summary>
    public class QueryComplaintNotifyUrlReturnJson : ReturnJsonBase
    {
        ...
        public QueryComplaintNotifyUrlReturnJson(string mchid, string url)
        {
            this.mchid = mchid;
            this.url = url;
        }
        ...
        /// 无参构造函数
        /// </summary>
        public QueryComplaintNotifyUrlReturnJson()
        {
        }
