...
/*----------------------------------------------------------------
    ...
    文件名：ApplyElecsignRequestData.cs
    文件功能描述：商家转账 - 申请电子回单API 请求数据
...
{
    /// <summary>
    /// 商家转账 - 商户单号申请电子回单API 请求数据
    /// <para>https://pay.weixin.qq.com/doc/v3/merchant/4012716452</para>
    /// </summary>
    public class ApplyElecsignByOutBillNoRequestData
    {
        /// <summary>
        /// 商户转账单号
    ...
    /// <summary>
    /// 商家转账 - 微信单号申请电子回单API 请求数据
    /// <para>https://pay.weixin.qq.com/doc/v3/merchant/4012716456</para>
    /// </summary>
    public class ApplyElecsignByBillNoRequestData
    {
        /// <summary>
        /// 微信转账单号
