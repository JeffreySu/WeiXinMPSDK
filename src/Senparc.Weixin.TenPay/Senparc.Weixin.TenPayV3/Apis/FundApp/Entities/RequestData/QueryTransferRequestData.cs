...
/*----------------------------------------------------------------
    ...
    文件名：QueryTransferRequestData.cs
    文件功能描述：商家转账 - 查询转账单API 请求数据
...
{
    /// <summary>
    /// 商家转账 - 商户单号查询转账单API 请求数据
    /// <para>https://pay.weixin.qq.com/doc/v3/merchant/4012716437</para>
    /// </summary>
    public class QueryTransferByOutBillNoRequestData
    {
        /// <summary>
        /// 商户单号
    ...
    /// <summary>
    /// 商家转账 - 微信单号查询转账单API 请求数据
    /// <para>https://pay.weixin.qq.com/doc/v3/merchant/4012716457</para>
    /// </summary>
    public class QueryTransferByBillNoRequestData
    {
        /// <summary>
        /// 微信转账单号
