...
/*----------------------------------------------------------------
    ...
    文件名：AssociateBusifavorRequestData.cs
    文件功能描述：关联商家券订单信息接口请求数据
...
namespace Senparc.Weixin.TenPayV3.Apis.Marketing
{
    ...
    /// </summary>
    public class AssociateBusifavorRequestData
    {
        ...
        public AssociateBusifavorRequestData(string stock_id, string coupon_code, string out_trade_no, string out_request_no)
        {
        ...
        /// 无参构造函数
        /// </summary>
        public AssociateBusifavorRequestData()
        {
        }

        /// <summary>
        /// 批次号
        /// <para>body 微信为每个商家券批次分配的唯一ID，对于商户自定义code的批次，关联请求必须填写批次号</para>
