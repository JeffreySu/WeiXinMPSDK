...
namespace Senparc.Weixin.TenPayV3.Apis.Marketing
{
    ...
    /// </summary>
    public class PatchBusifavorStockBudgetRequestData
    {
        /// <summary>
        /// 含参构造函数
        /// </summary>
        /// <param name="stock_id">批次号 <para>path批次号</para><para>示例值：98065001</para></param>
        /// <param name="target_max_coupons">目标批次最大发放个数 <para>body批次最大发放个数</para><para>注：目标批次即修改后的批次</para><para>示例值：3000</para></param>
        /// <param name="target_max_coupons_by_day">目标单天发放上限个数 <para>body单天发放上限个数</para><para>注：目标批次即修改后的批次</para><para>示例值：500</para>TODO:多选一</param>
        ...
        public PatchBusifavorStockBudgetRequestData(string stock_id, int target_max_coupons, int target_max_coupons_by_day, int current_max_coupons, int current_max_coupons_by_day, string modify_budget_request_no)
        {
        ...
        /// 无参构造函数
        /// </summary>
        public PatchBusifavorStockBudgetRequestData()
        {
        }
