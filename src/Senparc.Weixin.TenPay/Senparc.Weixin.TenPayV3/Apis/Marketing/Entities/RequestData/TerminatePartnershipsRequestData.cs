...
/*----------------------------------------------------------------
    ...
    文件名：TerminatePartnershipsRequestData.cs
    文件功能描述：终止合作关系接口请求数据
...
namespace Senparc.Weixin.TenPayV3.Apis.Marketing
{
    ...
    /// </summary>
    public class TerminatePartnershipsRequestData
    {
        ...
        public TerminatePartnershipsRequestData(BuildPartnershipsReturnJson buildPartnershipsReturnJson)
        {
        ...
        /// 无参构造函数
        /// </summary>
        public TerminatePartnershipsRequestData()
        {
        }
