...
namespace Senparc.Weixin.TenPayV3.Apis.Marketing
{
    ...
    /// </summary>
    public class DeactivateBusifavorCouponsReturnJson
    {
        ...
        public DeactivateBusifavorCouponsReturnJson(string wechatpay_deactivate_time)
        {
        ...
        /// 无参构造函数
        /// </summary>
        public DeactivateBusifavorCouponsReturnJson()
        {
        }
