...
/*----------------------------------------------------------------
    ...
    文件名：QueryBusifavorCouponsReturnJson.cs
    文件功能描述：根据过滤条件查询商家券的用户券Json类
...
{
    /// <summary>
    /// 根据过滤条件查询商家券的用户券Json类
    /// <para>详细请参考微信支付官方文档 https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter9_2_4.shtml </para>
    /// </summary>
    public class QueryBusifavorCouponsReturnJson : ReturnJsonBase
    {

        /// <summary>
        /// 含参构造函数
        /// </summary>
        /// <param name="data">结果集 <para>结果集</para></param>
        /// <param name="total_count">总数量  <para>总数量</para><para>示例值： 100</para></param>
        /// <param name="offset">分页页码  <para>分页页码</para><para>示例值：1</para></param>
        /// <param name="limit">分页大小  <para>分页大小</para><para>示例值：10</para></param>
        public QueryBusifavorCouponsReturnJson(Data[] data, int total_count, int offset, int limit)
        {
            this.data = data;
        ...
        /// 无参构造函数
        /// </summary>
        public QueryBusifavorCouponsReturnJson()
        {
        }
        ...
        public class Data
        {
            ...
            /// <summary>
            /// 券状态 
            /// <para>商家券状态 枚举值： SENDED：可用 USED：已核销 EXPIRED：已过期 </para>
            ...
            /// <summary>
            /// 券可使用开始时间 
            /// <para>1、用户领取到该张券实际可使用的开始时间，遵循rfc3339标准格式，格式为YYYY-MM-DDTHH:mm:ss+TIMEZONE，YYYY-MM-DD表示年月日，T出现在字符串中，表示time元素的开头，HH:mm:ss表示时分秒，TIMEZONE表示时区（+08:00表示东八区时间，领先UTC 8小时，即北京时间）。例如：2015-05-20T13:29:35.+08:00表示，北京时间2015年5月20日 13点29分35秒。</para>
            ...
            /// <summary>
            /// 券过期时间 
            /// <para>用户领取到该张券的过期时间，遵循rfc3339标准格式，格式为YYYY-MM-DDTHH:mm:ss+TIMEZONE，YYYY-MM-DD表示年月日，T出现在字符串中，表示time元素的开头，HH:mm:ss表示时分秒，TIMEZONE表示时区（+08:00表示东八区时间，领先UTC 8小时，即北京时间）。例如：2015-05-20T13:29:35.+08:00表示，北京时间2015年5月20日 13点29分35秒。</para>
            /// <para>示例值：2015-05-20T13:29:35+08:00 </para>
            /// </summary>
            ...
            /// <summary>
            /// 券领券时间 
            /// <para>用户领取到该张券的时间，遵循rfc3339标准格式，格式为YYYY-MM-DDTHH:mm:ss+TIMEZONE，YYYY-MM-DD表示年月日，T出现在字符串中，表示time元素的开头，HH:mm:ss表示时分秒，TIMEZONE表示时区（+08:00表示东八区时间，领先UTC 8小时，即北京时间）。例如：2015-05-20T13:29:35.+08:00表示，北京时间2015年5月20日 13点29分35秒。</para>
            /// <para>示例值：2015-05-20T13:29:35+08:00 </para>
            /// </summary>
            ...
            /// <summary>
            /// 发券请求单号
            /// <para>发券时传入的唯一凭证</para>
            /// <para>示例值: MCHSEND202003101234</para>
            /// </summary>
            public string send_request_no { get; set; }

            /// <summary>
            /// 核销请求单号
            /// <para>核销时传入的唯一凭证（如券已被核销，将返回此字段）</para>
            /// <para>示例值: MCHUSE202003101234</para>
            /// <para>可为null</para>
            /// </summary>
            ...
            /// <summary>
            /// 券核销时间
            /// <para>券被核销的时间（如券已被核销，将返回此字段）；遵循rfc3339标准格式，格式为YYYY-MM-DDTHH:mm:ss+TIMEZONE，YYYY-MM-DD表示年月日，T出现在字符串中，表示time元素的开头，HH:mm:ss表示时分秒，TIMEZONE表示时区（+08:00表示东八区时间，领先UTC 8小时，即北京时间）。例如：2015-05-20T13:29:35.+08:00表示，北京时间2015年5月20日 13点29分35秒。</para>
            /// <para>示例值：2015-05-20T13:29:35+08:00 </para>
            /// <para>可为null</para>
            /// </summary>
            ...
            public class Display_Pattern_Info
            {
                ...
                public Display_Pattern_Info(string merchant_logo_url, string merchant_name, string background_color, string coupon_image_url)
                {
            ...
            public class Coupon_Use_Rule
            {
                ...
                public class Discount_Coupon
                {
                    ...
                    /// <param name="transaction_minimum">消费门槛  <para>消费门槛，单位分</para><para>特殊规则：取值范围1≤value≤10000000</para><para>示例值：100</para></param>
