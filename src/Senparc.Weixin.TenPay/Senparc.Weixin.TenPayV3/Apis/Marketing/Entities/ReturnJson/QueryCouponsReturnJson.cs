...
/*----------------------------------------------------------------
    ...
    文件名：QueryCouponsReturnJson.cs
    文件功能描述：根据商户号查用户的券返回Json
...
namespace Senparc.Weixin.TenPayV3.Apis.Marketing
{
    /// <summary>
    /// 根据商户号查用户的券返回Json
    /// <para>详细请参考微信支付官方文档 https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter9_1_9.shtml </para>
    /// </summary>
    public class QueryCouponsReturnJson : ReturnJsonBase
    {
        /// <summary>
        /// 结果集
        /// </summary>
