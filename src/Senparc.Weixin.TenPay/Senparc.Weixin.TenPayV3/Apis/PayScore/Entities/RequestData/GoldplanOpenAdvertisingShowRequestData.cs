...
/*----------------------------------------------------------------
    ...
    文件名：GoldplanOpenAdvertisingShowRequestData.cs
    文件功能描述：微信支付V3开通广告展示请求数据
...
namespace Senparc.Weixin.TenPayV3.Apis.PayScore
{
    /// <summary>
    /// 微信支付V3开通广告展示请求数据
    /// <para>详细请参考微信支付官方文档 https://pay.weixin.qq.com/wiki/doc/apiv3_partner/apis/chapter8_5_4.shtml </para>
    /// </summary>
    public class GoldplanOpenAdvertisingShowRequestData
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public GoldplanOpenAdvertisingShowRequestData()
        {
        }
        ...
        public GoldplanOpenAdvertisingShowRequestData(string sub_mchid, List<string> advertising_industry_filters)
        { 
