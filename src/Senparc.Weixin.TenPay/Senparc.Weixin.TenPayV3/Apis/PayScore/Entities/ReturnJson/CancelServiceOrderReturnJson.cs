...
/*----------------------------------------------------------------
    ...
    文件名：CancelServiceOrderReturnJson.cs
    文件功能描述：取消支付分订单Json类
...
namespace Senparc.Weixin.TenPayV3.Apis.PayScore
{
    ...
    /// </summary>
    public class CancelServiceOrderReturnJson : ReturnJsonBase
    {
        ...
        public CancelServiceOrderReturnJson(string appid, string mchid, string out_order_no, string service_id, string order_id)
        {
            this.appid = appid;
            this.mchid = mchid;
        ...
        /// 无参构造函数
        /// </summary>
        public CancelServiceOrderReturnJson()
        {
        }
