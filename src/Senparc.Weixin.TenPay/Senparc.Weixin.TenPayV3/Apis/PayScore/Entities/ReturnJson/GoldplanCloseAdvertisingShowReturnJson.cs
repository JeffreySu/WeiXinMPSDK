...
/*----------------------------------------------------------------
    ...
    文件名：GoldplanCloseAdvertisingShowReturnJson.cs
    文件功能描述：关闭广告展示返回模型
...
namespace Senparc.Weixin.TenPayV3.Apis.PayScore
{
    ...
    /// </summary>
    public class GoldplanCloseAdvertisingShowReturnJson : ReturnJsonBase
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public GoldplanCloseAdvertisingShowReturnJson()
        {
