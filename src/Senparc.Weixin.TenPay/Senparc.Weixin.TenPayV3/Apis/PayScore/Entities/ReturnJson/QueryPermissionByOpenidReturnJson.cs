...
/*----------------------------------------------------------------
    ...
    文件名：QueryPermissionByOpenidReturnJson.cs
    文件功能描述：查询用户授权记录（openid）Json类
...
namespace Senparc.Weixin.TenPayV3.Apis.PayScore
{
    ...
    public class QueryPermissionByOpenidReturnJson : ReturnJsonBase
    {
        ...
        public QueryPermissionByOpenidReturnJson(string service_id, string appid, string mchid, string openid, string authorization_code, string authorization_state, string cancel_authorization_time, string authorization_success_time)
        {
        ...
        /// 无参构造函数
        /// </summary>
        public QueryPermissionByOpenidReturnJson()
        {
        }
