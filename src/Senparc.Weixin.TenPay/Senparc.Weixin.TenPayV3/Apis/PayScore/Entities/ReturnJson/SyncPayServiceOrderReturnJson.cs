...
/*----------------------------------------------------------------
    ...
    文件名：SyncPayServiceOrderReturnJson.cs
    文件功能描述：同步服务订单信息Json类
...
namespace Senparc.Weixin.TenPayV3.Apis.PayScore
{
    ...
    /// </summary>
    public class SyncPayServiceOrderReturnJson : ReturnJsonBase
    {
        ...
        public SyncPayServiceOrderReturnJson(string appid, string mchid, string out_order_no, string service_id, string service_introduction, string openid, string state, string state_description, long total_amount, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Risk_Fund risk_fund, Time_Range time_range, Location location, string attach, string notify_url, string order_id, bool need_collection, Collection collection)
        {
            this.appid = appid;
            this.mchid = mchid;
