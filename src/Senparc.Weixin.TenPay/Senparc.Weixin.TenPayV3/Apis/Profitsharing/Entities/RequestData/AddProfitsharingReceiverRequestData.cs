...
namespace Senparc.Weixin.TenPayV3.Apis.Profitsharing
{
    ...
    public class AddProfitsharingReceiverRequestData
    {
        ...
        public AddProfitsharingReceiverRequestData(string brand_mchid, string sub_appid, string appid, string type, string account, string name, string relation_type, string custom_relation, string sub_mchid = null)
        {
