...
/*----------------------------------------------------------------
    ...
    文件名：QueryProfitsharingBillsReturnJson.cs
    文件功能描述：申请分账账单Json类
...
namespace Senparc.Weixin.TenPayV3.Apis.Profitsharing
{
    ...
    /// </summary>
    public class QueryProfitsharingBillsReturnJson : ReturnJsonBase
    {
        ...
        public QueryProfitsharingBillsReturnJson(string hash_type, string hash_value, string download_url)
        {
        ...
        /// 无参构造函数
        /// </summary>
        public QueryProfitsharingBillsReturnJson()
        {
        }
