...
/*----------------------------------------------------------------
    ...
    文件名：CreateParkingReturnJson.cs
    文件功能描述：创建停车入场返回Json类
...
namespace Senparc.Weixin.TenPayV3.Apis.VehicleParking
{
    ...
    /// </summary>
    public class CreateParkingReturnJson : ReturnJsonBase
    {
        ...
        public CreateParkingReturnJson(string id, string out_parking_no, string plate_number, string plate_color, string start_time, string parking_name, int free_duration, string state, string block_reason)
        {
            this.id = id;
        ...
        /// 无参构造函数
        /// </summary>
        public CreateParkingReturnJson()
        {
        }
