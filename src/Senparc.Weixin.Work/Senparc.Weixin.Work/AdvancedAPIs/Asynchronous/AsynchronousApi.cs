...
namespace Senparc.Weixin.Work.AdvancedAPIs
{
    ...
    public static class AsynchronousApi
    {
        ...
        */
        ...
        /// }
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.BatchSyncUser", true)]
        ...
        /// }
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.BatchReplaceUser", true)]
        ...
        /// }
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.BatchReplaceParty", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.GetReplaceUserResult", true)]
        ...
        /// <param name="jobId"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.GetReplacePartyResult", true)]
        ...
        */
        ...
        /// }
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.BatchSyncUserAsync", true)]
        public static async Task<AsynchronousJobId> BatchSyncUserAsync(string accessTokenOrAppKey, string mediaId, Asynchronous_CallBack callBack, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                ...
                return await CommonJsonSend.SendAsync<AsynchronousJobId>(accessToken, url, data, CommonJsonSendType.POST, timeOut).ConfigureAwait(false);
        ...
        /// }
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.BatchReplaceUserAsync", true)]
        ...
        /// }
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.BatchReplacePartyAsync", true)]
        ...
        /// <param name="jobId"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.GetReplaceUserResultAsync", true)]
        public static async Task<AsynchronousReplaceUserResult> GetReplaceUserResultAsync(string accessTokenOrAppKey, string jobId)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                ...
                return await CommonJsonSend.SendAsync<AsynchronousReplaceUserResult>(accessToken, url, null, CommonJsonSendType.GET).ConfigureAwait(false);
            }, accessTokenOrAppKey).ConfigureAwait(false);
        ...
        /// <param name="jobId"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "AsynchronousApi.GetReplacePartyResultAsync", true)]
        public static async Task<AsynchronousReplacePartyResult> GetReplacePartyResultAsync(string accessTokenOrAppKey, string jobId)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                ...
                return await CommonJsonSend.SendAsync<AsynchronousReplacePartyResult>(accessToken, url, null, CommonJsonSendType.GET).ConfigureAwait(false);
            }, accessTokenOrAppKey).ConfigureAwait(false);
