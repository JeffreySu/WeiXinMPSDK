...
namespace Senparc.Weixin.Work.AdvancedAPIs
{
    ...
    public static class ConcernApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "ConcernApi.TwoVerification", true)]
        ...
        /// <param name="userId">员工UserID</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "ConcernApi.TwoVerificationAsync", true)]
