...
namespace Senparc.Weixin.Work.AdvancedAPIs
{
    ...
    public static class KFApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendText", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendImage", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendFile", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendVoice", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.GetKFList", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendTextAsync", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendImageAsync", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendFileAsync", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.SendVoiceAsync", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "KFApi.GetKFListAsync", true)]
