...
namespace Senparc.Weixin.Work.AdvancedAPIs
{
    public static class MailListApi
    {
        ...
        /// <returns></returns>
        public static WorkJsonResult CreateMember(string accessTokenOrAppId, string userId, string name = null,
        ...
        /// <returns></returns>
        public static WorkJsonResult UpdateMember(string accessTokenOrAppId, string userId, string name,
        ...
        /// <param name="userId">员工UserID</param>
        /// <returns></returns>
        public static WorkJsonResult DeleteMember(string accessTokenOrAppId, string userId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WorkJsonResult BatchDeleteMember(string accessTokenOrAppId, string[] useridlist, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WorkJsonResult UpdateDepartment(string accessTokenOrAppId, string id, string name, int parentId, int order = 1, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <returns></returns>
        public static WorkJsonResult DeleteDepartment(string accessTokenOrAppId, string id)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WorkJsonResult UpdateTag(string accessTokenOrAppId, int tagId, string tagName, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="tagId">标签ID</param>
        /// <returns></returns>
        public static WorkJsonResult DeleteTag(string accessTokenOrAppId, int tagId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static DelTagMemberResult DelTagMember(string accessTokenOrAppId, int tagId, string[] userList = null, int[] partylist = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <returns></returns>
        public static async Task<WorkJsonResult> CreateMemberAsync(string accessTokenOrAppId, string userId, string name,
            string mobile,
        ...
        /// accessToken和userId为必须的参数，其余参数不是必须的，可以传入null
        /// <returns></returns>
        public static async Task<WorkJsonResult> UpdateMemberAsync(string accessTokenOrAppId, string userId, string name,
            string mobile, string englishName = null,
            int[] department = null, int[] order = null, string gender = null,
            string position = null, string email = null, string telephone = null, string avatarMediaid = null,
            int? isLeader = null, int? enable = null,
        ...
        /// <param name="userId">员工UserID</param>
        /// <returns></returns>
        public static async Task<WorkJsonResult> DeleteMemberAsync(string accessTokenOrAppId, string userId)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/user/delete?access_token={0}&userid={1}", accessToken.AsUrlData(), userId.AsUrlData());
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static async Task<WorkJsonResult> BatchDeleteMemberAsync(string accessTokenOrAppId, string[] useridlist, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/user/batchdelete?access_token={0}", accessToken.AsUrlData());
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static async Task<WorkJsonResult> UpdateDepartmentAsync(string accessTokenOrAppId, string id, string name, int parentId, int order = 1, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/department/update?access_token={0}", accessToken.AsUrlData());
        ...
        /// <param name="id">部门id。（注：不能删除根部门；不能删除含有子部门、成员的部门）</param>
        /// <returns></returns>
        public static async Task<WorkJsonResult> DeleteDepartmentAsync(string accessTokenOrAppId, string id)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/department/delete?access_token={0}&id={1}", accessToken.AsUrlData(), id.AsUrlData());
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static async Task<WorkJsonResult> UpdateTagAsync(string accessTokenOrAppId, int tagId, string tagName, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = "https://qyapi.weixin.qq.com/cgi-bin/tag/update?access_token={0}";
        ...
        /// <param name="tagId">标签ID</param>
        /// <returns></returns>
        public static async Task<WorkJsonResult> DeleteTagAsync(string accessTokenOrAppId, int tagId)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/tag/delete?access_token={0}&tagid={1}", accessToken.AsUrlData(), tagId);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static async Task<DelTagMemberResult> DelTagMemberAsync(string accessTokenOrAppId, int tagId, string[] userList, int[] partylist = null, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = "https://qyapi.weixin.qq.com/cgi-bin/tag/deltagusers?access_token={0}";
