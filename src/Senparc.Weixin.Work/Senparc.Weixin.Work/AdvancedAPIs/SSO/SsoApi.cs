...
namespace Senparc.Weixin.Work.AdvancedAPIs
{
    ...
    public class SsoApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "SsoApi.GetLoginAuthUrl", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "SsoApi.GetProviderToken", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "SsoApi.GetLoginInfo", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "SsoApi.GetLoginInfoAsync", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "SsoApi.GetProviderTokenAsync", true)]
