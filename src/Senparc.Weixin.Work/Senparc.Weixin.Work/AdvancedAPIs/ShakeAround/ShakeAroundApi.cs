...
namespace Senparc.Weixin.Work.AdvancedAPIs
{
    public static class ShakeAroundApi
    {
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "ShakeAroundApi.GetSuiteToken", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "ShakeAroundApi.GetSuiteTokenAsync", true)]
