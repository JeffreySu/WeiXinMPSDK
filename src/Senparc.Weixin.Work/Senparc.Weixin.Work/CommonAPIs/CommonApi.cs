...
namespace Senparc.Weixin.Work.CommonAPIs
{
    ...
    public partial class CommonApi
    {
        ...
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.GetToken", true)]
...
*/
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.GetCallBackIp", true)]
        ...
        /// <param name="corpSecret"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.GetTicket", true)]
        ...
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.ConvertToOpenId", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.ConvertToUserId", true)]
        ...
        /// <param name="corpId"></param>
        /// <param name="corpSecret"></param>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.GetTokenAsync", true)]
...
*/
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.GetCallBackIpAsync", true)]
        ...
        /// <param name="corpSecret"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.GetTicketAsync", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.ConvertToOpenIdAsync", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [NcApiBind(NeuChar.PlatformType.WeChat_Work, "CommonApi.ConvertToUserIdAsync", true)]
