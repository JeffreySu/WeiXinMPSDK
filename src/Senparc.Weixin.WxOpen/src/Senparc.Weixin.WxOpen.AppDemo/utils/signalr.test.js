            ...
            var xhrMiniprogram = wx.request({
                ...
                fail: function (res) {
                    ...
                    if (res.errMsg.includes('timeout')) {
                        ...
                        _this.logger.log(_ILogger__WEBPACK_IMPORTED_MODULE_2__["LogLevel"].Warning, "Error from HTTP request. " + res.statusCode + ": " + statusText + ".");
                        reject(new _Errors__WEBPACK_IMPORTED_MODULE_0__["HttpError"](statusText, res.statusCode));
                    }
                }
            });
