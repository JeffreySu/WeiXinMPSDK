...
namespace Senparc.Weixin.WxOpen.AdvancedAPIs
{
    ...
    public class MessageApi
    {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult SendEmployeeRelationMessage(string accessTokenOrAppId, string toUser, string templateId, TemplateMessageData data, string page = null,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static async Task<WxJsonResult> SendEmployeeRelationMessageAsync(string accessTokenOrAppId, string toUser, string templateId, TemplateMessageData data, string page = null,
            int timeOut = Config.TIME_OUT)
        {
            return await WxOpenApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
