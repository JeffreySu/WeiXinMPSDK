...
exports.WeixinDevSidebarProvider = void 0;
const vscode = require("vscode");
class WeixinDevSidebarProvider {
    constructor(_extensionUri, _apiService, _interfaceInserter) {
        this._extensionUri = _extensionUri;
        this._apiService = _apiService;
        this._interfaceInserter = _interfaceInserter;
    }
    ...
    async _handleQueryInterface(query) {
        try {
...
exports.WeixinDevSidebarProvider = WeixinDevSidebarProvider;
WeixinDevSidebarProvider.viewType = 'weixindev.sidebar';
