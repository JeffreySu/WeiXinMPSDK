...
// 根据查询生成代码
function generateCodeByQuery(query: string): string {
...
// 根据查询生成注释
function generateCommentsByQuery(query: string): string {
    const lowerQuery = query.toLowerCase();
...
// 插入代码到编辑器
async function insertCodeToEditor(code: string, comments?: string): Promise<void> {
