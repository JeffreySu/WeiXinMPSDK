        ...
        try {
            ...
            await vscode.window.withProgress({
                ...
                try {
                    ...
                    const apiUrl = config.get<string>('apiUrl', 'https://sdk.weixin.senparc.com/AiDoc');
                    ...
                    // 在调试模式下显示详细错误信息
                    const debugMode = vscode.workspace.getConfiguration('weixindev').get<boolean>('enableDebugMode', false);
                    if (debugMode) {
